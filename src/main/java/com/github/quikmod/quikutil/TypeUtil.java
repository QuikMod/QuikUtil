...
public final class TypeUtil {
	 ...
	 * suffers from the same issue outlined in {@link TypeUtil#asList}.
	 *
	 * @param <T> the class of the objects in the array.
	 ...
	 * @exception NullPointerException if any of the types are
	 * null.
	 */
    @SafeVarargs
    ...
    /**
     * Determines the object value of the given object, by returning the object itself or returning null in the case that the object is a class.
     *
     * @param obj the object to determine the class value of.
     * @return the class value of the object.
     */
